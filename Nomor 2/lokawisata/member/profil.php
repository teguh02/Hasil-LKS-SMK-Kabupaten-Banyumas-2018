					...
					<div class="t-col l6 s6 m6">
						<div class="t-container t-padding-right-3">
							<div class="">
								...
								<a class="t-text-white" href="#"><div class="keluar t-margin-left-2">Profil</div></a>
				...
				<div class="t-row">
					<div class="t-col l12 s12 m12">
						<div class="t-content t-padding-2 t-padding-top-1">
							...
							<form action="hapus.php" action="post" class="t-margin-top-1">
								<input type="hidden" value="<?php echo $ambil['id'] ?>" name="id" >

								<input class="t-input t-large" value="<?php echo $ambil['nama'] ?>" type="text" name="nama" placeholder="Masukan Nama">

								<input disabled="" class="t-input t-margin-top-1 t-large" value="<?php echo $ambil['email'] ?>" type="text" name="nama" placeholder="Masukan Nama">

								<input class="t-input t-margin-top-1 t-large" value="<?php echo $ambil['sandi'] ?>" type="text" name="sandi" placeholder="Masukan Kata Sandi">

								<input type="submit" name="update" class="t-input t-margin-top-1 t-blue" value="Hapus Data">
								<center><a class="batal" href="index.php">Batal</a></center>
							</form>
						</div>
					</div>
				</div>
