...
<head>
	...
	<style type="text/css">
		...
		td {text-align: center; padding: 1%} table {width: 100%}
	</style>
</head>
				...
				<div class="t-row">
					<div class="t-col l12 s12 m12">
						<div class="t-content t-padding-2 t-padding-top-1">
							...
							<h2>Daftar Artikel Yang Menunggu Persetujuan 

								<?php
							if (isset($_GET['pesan'])) {
								if ($_GET['pesan'] == "updated") {
									echo "Berhasil di Perbarui!";
								} elseif ($_GET['pesan'] == "disetujui") {
									echo "Berhasil di Posting!";
								} elseif ($_GET['pesan'] == "gagal-posting") {
									echo "Gagal di Posting!";
								}
							}
					?>
							...
							<!--Query Mengambil Artikel-->

							<?php

									$sql1 = "SELECT * FROM belum";
