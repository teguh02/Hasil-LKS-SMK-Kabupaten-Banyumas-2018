...
<head>
	...
	<style type="text/css">
		...
		.member {background-color: white !important;cursor: pointer;}
		.admin 	{background-color: #f1f1f1 !important;color: #777 !important;cursor: pointer;} .admin:hover {color: black !important}
...
<body class="t-light-grey">
	<div class="t-content">
		...
		<div class="t-container t-hide-large  form">
			<div class="t-row">
		...
		<div class="t-container t-margin-top-1 t-hide-small t-hide-medium t-padding-2 form">
			<div class="t-row">
				<div class="t-col l6 s6 m6 member">
					<div class="t-padding-2">
						<center>
